...
import { NormandyBeach } from './NormandyBeach';
...
export type MapId = 'berlin_ruins' | 'ardennes' | 'normandy_beach' | 'training_range';
  ...
  loadMap(mapName: string): void {
    ...
    switch (mapName) {
      ...
      case 'ardennes':
        ...
        break;
      case 'normandy_beach':
        this.currentMap = new NormandyBeach(this.scene);
        break;
      case 'training_range':
